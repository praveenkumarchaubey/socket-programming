...
*	DESCRIPTION:Contains Code for a echo  client, that will accept data from the user(keyboard) and sends
*  	that data  to a echo server process and prints the received data back on the screen. (UDP)
